class TestData:
    test_data_user1 = ['Джон', 'Сноу', 'Винтерфелл,1', 'Красные ворота', '+78881414223', '30.07.2024', 'Зима близко']
    test_data_user2 = ['Дайнерис', 'Таргариен', 'Драконий Камень,1', 'Парк Победы', '+79991313224', '29.07.2024', 'Пламя и кровь']
