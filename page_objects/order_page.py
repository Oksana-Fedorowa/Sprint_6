...
class OrderPage(BasePage):
    @allure.step('Кликь по  варианту в выпадающем списке станций метро')
    ...
    @allure.step('Заполняем первую часть формы и нажимаем кнопку "Далее"')
    ...
    @allure.step('Заполняем вторую часть формы и кликаем в окне подтверждения')
